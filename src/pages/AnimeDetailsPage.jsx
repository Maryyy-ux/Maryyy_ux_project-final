    ...
    return (
        <div style={{
            ...
            <div style={{ flex: "2", paddingRight: "20px" }}>
                <h2>{anime.title}</h2>
                <p><strong>Estudio:</strong> {anime.studios?.map(studio => studio.name).join(", ") || "Desconocido"}</p>
                    ...
                    <div style={{ marginTop: "20px" }}>
                        ...
                        {comments.map((comment, index) => (
                            <div key={index} style={{ marginTop: "10px", padding: "10px", background: "#333", borderRadius: "5px" }}>
                                <p>{comment.text}</p>
                                <button onClick={() => handleReplySubmit(index, prompt("Escribe tu respuesta:"))}>💬 Reply</button>
